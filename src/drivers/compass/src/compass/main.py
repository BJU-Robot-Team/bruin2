...
ros_interface = ros_interface.ROSInterface()
...
compass = compass_data.CompassData(0)

manipulator = compass_node.ManipulateData()
...
while (True):
    ...
    comp_data = manipulator.parse_data(raw_data)
